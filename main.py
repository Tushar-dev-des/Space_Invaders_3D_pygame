...
# loading images
RED_SPACE_SHIP = pygame.image.load('ship_red_small.png')
GREEN_SPACE_SHIP = pygame.image.load('ship_green_small.png')
BLUE_SPACE_SHIP = pygame.image.load('ship_blue_small.png')

# player ship
YELLOW_SPACE_SHIP = pygame.image.load('ship_yellow.png')
...
YELLOW_LASER = pygame.image.load('yellow_bullet.png')

# background img load

BG = pygame.image.load('bg.png')
STARS_BG = pygame.image.load('stars.png')
PLANETS_BG = pygame.image.load('planets.png')
...
def main():
    ...
    lost = False
    lost_count = 0
    stars_bg_y_pos = -3800 + HEIGHT
    planets_bg_y_pos = -3800 + HEIGHT

    # WIN.blit(GAME_BG, (0, 0))

    def redraw_window():

        # WIN.blit(GAME_BG, (0, game_bg_y_pos))
        # draw text
        lives_label = main_font.render(f"Lives: {lives}", 1, (255, 255, 255))
        score_label = main_font.render(
            f"score: {'%0.0f'%score}", 1, (255, 255, 255))
    ...
    while run:
        ...
        stars_bg_y_pos += 0.3
        WIN.blit(STARS_BG, (0, stars_bg_y_pos))
        if stars_bg_y_pos >= 0:
            stars_bg_y_pos = -3800 + HEIGHT

        planets_bg_y_pos += 0.7
        WIN.blit(PLANETS_BG, (0, planets_bg_y_pos))
        if planets_bg_y_pos >= 0:
            planets_bg_y_pos = -3800 + HEIGHT
